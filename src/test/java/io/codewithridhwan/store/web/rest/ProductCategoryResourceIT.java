...
public class ProductCategoryResourceIT {
    ...
    public void createProductCategory() throws Exception {
        ...
        assertThat(testProductCategory.getStreetAddress()).isEqualTo(DEFAULT_STREET_ADDRESS);
        assertThat(testProductCategory.getPostalCode()).isEqualTo(DEFAULT_POSTAL_CODE);
        assertThat(testProductCategory.getCity()).isEqualTo(DEFAULT_CITY);
        assertThat(testProductCategory.getStateProvince()).isEqualTo(DEFAULT_STATE_PROVINCE);
    ...
    public void updateProductCategory() throws Exception {
        ...
        ProductCategory testProductCategory = productCategoryList.get(productCategoryList.size() - 1);
        assertThat(testProductCategory.getStreetAddress()).isEqualTo(UPDATED_STREET_ADDRESS);
        assertThat(testProductCategory.getPostalCode()).isEqualTo(UPDATED_POSTAL_CODE);
        assertThat(testProductCategory.getCity()).isEqualTo(UPDATED_CITY);
        assertThat(testProductCategory.getStateProvince()).isEqualTo(UPDATED_STATE_PROVINCE);
